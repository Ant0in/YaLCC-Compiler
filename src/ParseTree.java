...
public class ParseTree {
    ...
    /**
     * Gets the label of the root of the tree.
     *
    ...
    /**
     * Gets the list of children of the root node.
     *
    ...
    public String toForestPicture() {
        return (
            "\\begin{forest}for tree={rectangle, draw, l sep=20pt}" +
            toLaTexTree() +
            ";\n\\end{forest}"
        );
    }
    ...
    public String toTikZPicture() {
        return (
            "\\begin{tikzpicture}[tree layout,every node/.style={draw,rounded corners=3pt}]\n\\" +
            toTikZ() +
            ";\n\\end{tikzpicture}"
        );
    }
